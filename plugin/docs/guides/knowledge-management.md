...
For the lookup and write conventions of `org/docs/`, see the `org-knowledge-overlay` rule (always-on).
**Users do not edit the plugin's bundled `docs/` directly** (it is read-only); corrections go to the workspace `org/docs/` overlay.
